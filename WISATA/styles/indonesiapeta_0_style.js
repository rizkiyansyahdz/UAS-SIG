...
var style_indonesiapeta_0 = function(feature, resolution){
    ...
    if (value > 2.000000 && value <= 4.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4.600000 && value <= 7.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7.200000 && value <= 9.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 9.800000 && value <= 12.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12.400000 && value <= 15.000000) {
            style = [ new ol.style.Style({
